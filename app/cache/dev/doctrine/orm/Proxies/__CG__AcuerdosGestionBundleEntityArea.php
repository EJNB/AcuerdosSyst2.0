 ...
 */
class Area extends \Acuerdos\GestionBundle\Entity\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acuerdos\\GestionBundle\\Entity\\Area' . "\0" . 'id', '' . "\0" . 'Acuerdos\\GestionBundle\\Entity\\Area' . "\0" . 'area', '' . "\0" . 'Acuerdos\\GestionBundle\\Entity\\Area' . "\0" . 'personas');
        }
